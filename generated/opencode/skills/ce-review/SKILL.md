---
name: ce-review
description: 基于 KB 的代码审查。 Pilot 管阶段；本 Skill 只索引 Action。
---
...
|---|---|---|---|---|
| `code_review` | 代码审查 | `ce-review/code-review` | `ce-reviewer` | `readonly_analyst` |
...
|---|---|---|---|---|
| `code_review` | `actions/code-review/METHOD.md` | `prompts/tasks/ce/code-review.md` | `code-review-v1` | `readonly_analyst` |

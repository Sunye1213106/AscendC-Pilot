---
name: tg-plan
description: 生成覆盖义务并人工批准。 Pilot 管阶段；本 Skill 只索引 Action。
---
...
|---|---|---|---|---|---|
| `plan_scope` | source-authority,code-access,evidence,language,pilot-control,output-quality | obligation-analysis,kb-query | `tg-plan/plan-scope` | `-` | `deterministic-tg-engine` |
...
| `plan_build` | source-authority,code-access,evidence,language,pilot-control,output-quality | obligation-analysis,kb-query | `tg-plan/plan-build` | `-` | `deterministic-tg-engine` |
| `plan_approve` | source-authority,code-access,evidence,language,pilot-control,output-quality | - | `tg-plan/plan-approve` | `tg/plan-approve` | `human` |

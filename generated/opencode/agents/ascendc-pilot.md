---
name: ascendc-pilot
description: AscendC-Pilot primary control agent. Load workflow skills by description
  (uo-init / tg-init / …) then acp start; Build/Plan tabs bypass harness.
mode: primary
permission:
  bash:
    '*': deny
...
AscendC-Pilot primary control agent. Load workflow skills by description (uo-init / tg-init / …) then acp start; Build/Plan tabs bypass harness.

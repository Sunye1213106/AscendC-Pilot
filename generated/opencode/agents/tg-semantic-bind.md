...
description: Bounded semantic-bind producer; writes candidate-cited patches only.
...
Bounded semantic-bind producer; writes candidate-cited patches only. On start, read session prompt.md first.

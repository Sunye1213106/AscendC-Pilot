...
|---|---|---|---|---|---|
| `solve_precheck` | source-authority,code-access,evidence,language,pilot-control,output-quality | tilingkey-closure | `tg-solve/solve-precheck` | `-` | `deterministic-tg-engine` |
| `oracle_probe` | source-authority,code-access,evidence,language,pilot-control,output-quality | tilingkey-closure | `tg-solve/oracle-probe` | `-` | `deterministic-tg-engine` |
| `closure_ledger` | source-authority,code-access,evidence,language,pilot-control,output-quality | tilingkey-closure | `tg-solve/closure-ledger` | `-` | `deterministic-tg-engine` |
| `closure_search` | source-authority,code-access,evidence,language,pilot-control,output-quality | tilingkey-closure | `tg-solve/closure-search` | `-` | `deterministic-tg-engine` |
| `closure_residual` | source-authority,code-access,evidence,language,pilot-control,output-quality | tilingkey-closure | `tg-solve/closure-residual` | `-` | `deterministic-tg-engine` |
| `closure_construct` | source-authority,code-access,evidence,language,pilot-control,output-quality | tilingkey-closure | `tg-solve/closure-construct` | `-` | `deterministic-tg-engine` |
| `closure_explain` | source-authority,code-access,evidence,language,pilot-control,output-quality | tilingkey-closure | `tg-solve/closure-explain` | `-` | `deterministic-tg-engine` |
| `lemma_leads` | source-authority,code-access,evidence,language,pilot-control,output-quality | tilingkey-closure | `tg-solve/lemma-leads` | `-` | `deterministic-tg-engine` |
| `lemma_mine` | source-authority,code-access,evidence,language,pilot-control,output-quality | tilingkey-closure,source-reading,cbm-navigation | `tg-solve/lemma-mine` | `tg/lemma-mine` | `tg-lemma-producer` |
| `lemma_review` | source-authority,code-access,evidence,language,pilot-control,output-quality | tilingkey-closure,structured-review | `tg-solve/lemma-review` | `tg/lemma-review` | `tg-closure-referee` |
| `lemma_apply` | source-authority,code-access,evidence,language,pilot-control,output-quality | tilingkey-closure | `tg-solve/lemma-apply` | `-` | `deterministic-tg-engine` |
| `closure_audit` | source-authority,code-access,evidence,language,pilot-control,output-quality | tilingkey-closure,structured-review | `tg-solve/closure-audit` | `tg/closure-audit` | `tg-closure-referee` |
| `closure_certify` | source-authority,code-access,evidence,language,pilot-control,output-quality | tilingkey-closure | `tg-solve/closure-certify` | `-` | `deterministic-tg-engine` |
...
| `oracle_probe` | `actions/oracle-probe/METHOD.md` | `-` | `oracle-probe-v1` | `deterministic_engine` |
| `closure_ledger` | `actions/closure-ledger/METHOD.md` | `-` | `closure-ledger-v1` | `deterministic_engine` |
| `closure_search` | `actions/closure-search/METHOD.md` | `-` | `closure-search-v1` | `deterministic_engine` |
| `closure_residual` | `actions/closure-residual/METHOD.md` | `-` | `closure-residual-v1` | `deterministic_engine` |
| `closure_construct` | `actions/closure-construct/METHOD.md` | `-` | `closure-construct-v1` | `deterministic_engine` |
| `closure_explain` | `actions/closure-explain/METHOD.md` | `-` | `closure-explain-v1` | `deterministic_engine` |
| `lemma_leads` | `actions/lemma-leads/METHOD.md` | `-` | `lemma-leads-v1` | `deterministic_engine` |
| `lemma_mine` | `actions/lemma-mine/METHOD.md` | `prompts/tasks/tg/lemma-mine.md` | `lemma-mine-v1` | `producer` |
| `lemma_review` | `actions/lemma-review/METHOD.md` | `prompts/tasks/tg/lemma-review.md` | `lemma-review-v1` | `referee` |
| `lemma_apply` | `actions/lemma-apply/METHOD.md` | `-` | `lemma-apply-v1` | `deterministic_engine` |
| `closure_audit` | `actions/closure-audit/METHOD.md` | `prompts/tasks/tg/closure-audit.md` | `closure-audit-v1` | `referee` |
| `closure_certify` | `actions/closure-certify/METHOD.md` | `-` | `closure-certify-v1` | `deterministic_engine` |

---
name: tg-plan
description: TG stage-2 after tg-init confirmed. LLM maps human scope to KEY/VAR/branch
  (empty=all input-reachable); default L0+L1; optional L2. Approve only when Allow
  solve:yes.
argument-hint: <算子仓> --op-name <op> [--focus <vars/keys>] [--level L0,L1|all] [--topic
  <scope>]
...
| 权威 | 说明 |
|---|---|
| `.ascendc-agent/tg/contract/testcase.yaml` | TG 测项合同 |

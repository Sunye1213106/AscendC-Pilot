---
name: ascendc-pilot
description: AscendC-Pilot primary control agent. Tab-select this agent before /uo-init|/tg-init|/ce-review;
  default Build agent will skip pilot.
mode: primary
permission:
  bash:
    '*': deny
...
AscendC-Pilot primary control agent. Tab-select this agent before /uo-init|/tg-init|/ce-review; default Build agent will skip pilot.

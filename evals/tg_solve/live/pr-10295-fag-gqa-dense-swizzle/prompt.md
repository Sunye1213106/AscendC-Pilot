...
<input>
- Plan: `D:/PR-review/AscendC-Pilot/evals/fixtures/tg-plan/pr-10295-fag-gqa-dense-swizzle/session/trial-c25-fill3.yaml`
...
- Solve index: `D:/PR-review/AscendC-Pilot/evals/tg_solve/live/pr-10295-fag-gqa-dense-swizzle/solve_index.yaml`
- project_root: `D:/PR-review/TEST/.ascendc-pr/gitcode.com--cann--ops-transformer--pr-10295/attention/flash_attention_score_grad`
</input>

<method>

先读 `D:/PR-review/AscendC-Pilot/evals/tg_solve/live/pr-10295-fag-gqa-dense-swizzle/method.md`，那就是本窗形式规范。禁止打开 `evals/fixtures` 下除 Plan 输入路径以外的文件。禁止读 rubric / grade / trial。

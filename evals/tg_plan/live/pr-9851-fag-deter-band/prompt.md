...
先读 `D:/PR-review/AscendC-Pilot/evals/tg_plan/live/pr-9851-fag-deter-band/method.md`，那就是本窗形式规范。禁止打开 `evals/fixtures`。禁止读 plan.golden.md / rubric.yaml / grade_*.py / session/trial*.yaml。

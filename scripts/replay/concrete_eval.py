...
This module lives on the replay side (moved out of ``uo_init``). Replay uses
``Premises`` to gate generated cases against extracted legality conditions.
...
except ImportError:  # replay can run without the UO package on PATH

...
2. After start, prefer `acp run-action auto` to drain consecutive deterministic Actions and phase transitions. Do not dispatch deterministic engine identities as OpenCode Tasks.

---
name: ascendc-pilot
description: 'Main coordinator for AscendC-Pilot workflows. Load the relevant workflow
  entry skill, then acp start and delegate authorized actions. Domain methods live
  under skills/operator-analysis, skills/testcase-generation, skills/source-proof,
  and skills/code-review.
...
Main coordinator for AscendC-Pilot workflows. Load the relevant workflow entry skill, then acp start and delegate authorized actions. Domain methods live under skills/operator-analysis, skills/testcase-generation, skills/source-proof, and skills/code-review.

---
name: tg-semantic-bind
description: Semantic bind producer. Read session prompt.md first, then skills/testcase-generation/SKILL.md.
mode: subagent
permission:
  bash:
    '*': deny
...
Semantic bind producer. Read session prompt.md first, then skills/testcase-generation/SKILL.md.

---
name: tg-init-audit
description: TG init audit referee. Read session prompt.md first, then skills/testcase-generation/SKILL.md.
mode: subagent
permission:
  bash:
    '*': deny
...
TG init audit referee. Read session prompt.md first, then skills/testcase-generation/SKILL.md.

...
Domain method: `skills/code-review/SKILL.md`.
...
|---|---|---|---|---|---|
| `code_review` | source-authority,code-access,evidence,language,pilot-control,output-quality | kb-query,source-navigation,source-reading | `ce-review/code-review` | `ce/code-review` | `ce-reviewer` |

## Action runtime index

| action_id | method_path | prompt_path | output_contract | role |
|---|---|---|---|---|
| `code_review` | `actions/code-review/action.yaml` | `prompts/tasks/ce/code-review.md` | `code-review-v1` | `readonly_reviewer` |

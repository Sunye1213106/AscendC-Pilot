...
|---|---|---|---|---|---|
| `kb_lookup` | source-authority,code-access,evidence,language,pilot-control,output-quality | kb-query,source-navigation,source-reading | `uo-query/kb-lookup` | `uo/codemap-query` | `uo-query` |

## Action runtime index

| action_id | method_path | prompt_path | output_contract | role |
|---|---|---|---|---|
| `kb_lookup` | `actions/kb-lookup/action.yaml` | `prompts/tasks/uo/codemap-query.md` | `kb-answer-v1` | `readonly_analyst` |

...
ACTION_FINALIZER_WRITE_PATHS: dict[str, dict[str, list[str]]] = {
    ...
    "tg-solve": {
        "compile_obligations": ["tg/worklog.md"],
        "construct_promote": [],
...
ACTION_WRITE_PATHS: dict[str, dict[str, list[str]]] = {
    ...
    "tg-solve": {
        ...
        "construct_cases": [],
        "construct_promote": [
            "runs/{run_id}/receipts/construct_promote.yaml",
            "tg/replay/**",
        ],
        "replay_round": ["runs/{run_id}/receipts/replay_round.yaml", "tg/replay/**"],
...
ACTION_READ_PATHS: dict[str, dict[str, list[str]]] = {
    ...
    "tg-plan": {
        ...
        "plan_promote": [
            "tg/plan.md",
            "runs/{run_id}/actions/plan_fuse/**",
            "runs/{run_id}/actions/plan_narrate/**",
            "runs/{run_id}/actions/plan_scope/**",
        ],
    ...
    "tg-solve": {
        ...
        "compile_obligations": ["uo/*.uo", "tg/init.yaml", "tg/plan.md", "tg/worklog.md"],
        "construct_cases": [
            "uo/*.uo",
            "tg/init.yaml",
            "tg/plan.md",
        ...
        "replay_round": ["tg/init.yaml", "tg/plan.md", "tg/replay/**", "local/**"],
        "coverage_eval": [
            "tg/init.yaml",
            "tg/plan.md",
            "tg/worklog.md",

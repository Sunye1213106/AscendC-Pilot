    ...
    *,
    ...
    "tg-plan": {
        ...
        "pipelines": {
            "gate": ["plan_precheck"],
            "scope": ["plan_scope"],
            "fuse": ["plan_fuse", "plan_narrate", "plan_promote"],
        ...
        "actions": [
            ...
            _act(
                ...
                output_contract_id="tg-plan-fuse-v1",
                output_mode="return_value",
                allowed_write_paths=[],
                produces=[],
            ),
            _act(
                ...
                capability_ids=[],
                skill_id="test-plan",
                method_ref="plan-narrate.md",
                task_prompt_id="tg/plan-narrate",
                output_contract_id="tg-plan-narrate-v1",
                output_mode="return_value",
                allowed_write_paths=[],
                produces=[],
            ),

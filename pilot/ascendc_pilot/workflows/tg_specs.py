    ...
    "tg-plan": {
        ...
        "actions": [
            ...
            _act(
                ...
                capability_ids=[],
                skill_id="test-plan",
                method_ref="coverage-planning.md",
                refs=["target-planning.md", "evidence.md"],
                knowledge_refs=[
    ...
    "tg-solve": {
        ...
        "actions": [
            ...
            _act(
                ...
                refs=[
                    "targeted-construct.md",
                    "precision-construction.md",
                    "performance-construction.md",
                ],

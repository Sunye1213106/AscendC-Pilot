...
WORKFLOWS: dict[str, dict[str, Any]] = {
    ...
    "ce-impact": {
        ...
        "actions": [
            ...
            _act(
                ...
                role_id="producer",
                capability_ids=["kb-query", "source-navigation", "source-reading"],
                task_prompt_id="ce/scenario-infer",
            ...
            _act(
                ...
                capability_ids=[],
                task_prompt_id="ce/scenario-confirm",
    ...
    "ce-intent": {
        ...
        "write_roots": ["ce/intent", "ce/scenarios", "runs", "context"],
        "reset_policy": {
        ...
        "phases": ["intent", "kb_ready", "decompose", "review", "locate", "confirm"],
        "gates": ["kb_ready"],
    },
    "tg-init": {
        "slash": "/tg-init",
    ...
    "tg-plan": {
        ...
        "actions": [
            ...
            _act(
                ...
                human_interaction="confirm",
                capability_ids=[],
                task_prompt_id="tg/scenario-plan",
                context_profile_id="tg-plan-scenario-plan",
                output_contract_id="scenario-plan-v1",
            ),
            _act(
                "plan_scope",
                label_zh="确定规划范围",
        ...
        "mode_overlays": {
            ...
            "scenario_targeted": {
                "pipelines": {
                    "intent": ["plan_intent", "scenario_plan"],
                    "scope": ["plan_scope"],
                    "gate": ["plan_precheck"],
                    "build": ["plan_build"],
                    "filter": ["plan_build"],
                ...
                "action_overrides": {
                    "plan_intent": {
                        "label_zh": "冻结 ScenarioSet 规划目标",
                        "allowed_read_paths": [
                            "uo/*.uo",
                            "tg/init/**",
                            "context/**",
                            "ce/scenarios/scenario_set.yaml",
                            "ce/scenarios/confirmation.yaml",
                        ],
                    },
                },
            },
    ...
    "tg-solve": {
        ...
        "mode_overlays": {
            ...
            "scenario_targeted": {
                ...
                "states": [
                    _st("gate", "求解前置"),
                    _st("construct", "场景定向构造"),
                    _st("certify", "签发场景覆盖证书"),
                ],
                "transitions": [
                    _tr("gate", "construct"),
                    _tr("construct", "certify"),
                ],
                "phase_gates": {
                    "gate": ["plan_approved", "kb_fingerprint_fresh"],
                },
                "pipelines": {
                    "gate": ["solve_precheck"],
                    "construct": ["targeted_construct", "harness_run"],
                    "certify": ["scenario_certify"],
                },
            },
        },
        "meta": {
        ...
        "actions": [
            ...
            _act(
                "targeted_construct",
                label_zh="按场景检索变异并写出 CSV",
                phases=["construct"],
                workflow_id="tg-solve",
                agent_id="deterministic-tg-engine",
                role_id="deterministic_engine",
                capability_ids=[],
                output_contract_id="targeted-construct-v1",
            ),
            _act(
                "harness_run",
                label_zh="调用测试仓跑精度或性能",
                phases=["construct"],
                workflow_id="tg-solve",
                agent_id="deterministic-tg-engine",
                role_id="deterministic_engine",
                capability_ids=[],
                output_contract_id="harness-run-v1",
            ),
            _act(
                "scenario_certify",
                label_zh="签发场景覆盖证书",
                ...
                role_id="deterministic_engine",
                capability_ids=[],
                output_contract_id="scenario-coverage-v1",
            ),
            _act(
                "lemma_leads",
            ...
            _act(
                ...
                context_profile_id="tg-solve-lemma-mine",
            ...
            _act(
                ...
                context_profile_id="tg-solve-lemma-review",
            ...
            _act(
                ...
                context_profile_id="tg-solve-closure-audit",

...
WORKFLOWS: dict[str, dict[str, Any]] = {
    "uo-init": {
        ...
        "phase_gates": {
            "prepare": ["prepare_layout_receipt"],
            "scope": ["scope_receipt"],
            "extract": [
                "detect_score_pre",
        ...
        # Sole authority for mandatory action order within a phase (pipeline.py reads this).
        "pipelines": {
        ...
        "meta": {
            ...
            "recovery_by_reason": {
                ...
                "INPUT_DERIVABLE_REWORK": {"type": "action", "action_id": "key_triage"},
                "MACRO_MATERIALIZE_REWORK": {"type": "action", "action_id": "rebuild_from_ledger"},
                "KEY_DERIVATION_REWORK": {"type": "action", "action_id": "key_triage"},
                "SCOPE_EXPANSION_REWORK": {"type": "action", "action_id": "apply_scope_expansion"},
            },
        },
        "actions": [
            _act(
            ...
            _act(
                ...
                capability_ids=[],
                task_prompt_id=None,
                output_contract_id="scope-expansion-v1",
            ),
            _act(
                "rebuild_from_ledger",
                label_zh="由账本重建派生图",
    ...
    "uo-update": {
        ...
        "actions": [
            ...
            _act(
                ...
                gates=["key_triage_required"],
                capability_ids=_CAPS_RESOLVE,
                action_method_id="uo-init/key-triage",
                task_prompt_id="uo/key-triage",
                output_contract_id="key-triage-v1",
            ),
            _act(
                ...
                agent_id="uo-key-resolve",
                role_id="producer",
                gates=["key_triage_required", "key_resolve_receipt", "empty_only_producer"],
                capability_ids=_CAPS_RESOLVE,
                action_method_id="uo-init/key-resolution",
                task_prompt_id="uo/key-resolution",
                output_contract_id="input-derivable-patch-v1",
            ),
            _act(
            ...
            _act(
                ...
                gates=["confidence_reason_review"],
                capability_ids=_CAPS_REVIEW,
                action_method_id="uo-init/confidence-review",
                task_prompt_id="uo/confidence-review",
                output_contract_id="confidence-reason-review-v1",
            ),
            _act(

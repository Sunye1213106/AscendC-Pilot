...
from uo_init.tpl_dsl import _uint_bit_width, expand_tpl_source, load_quoted_include_texts, parse_args_decl
...
def _parse_tiling_data(codemap: CodeMap, root: Path, architecture: str) -> dict[str, Any]:
    ...
    for path in list(selected_tiling_headers(root, architecture)) + list(
        ...
        files.append(path)
    try:
        from uo_init.paths import ops_root as _ops_root

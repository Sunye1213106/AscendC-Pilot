"""Apply pilot-bounded semantic bind patches against llm_bind_prompt_bundle candidates."""
...
def apply_semantic_bind_patch(out_root: Path, patch: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    unresolved_out = {
        ...
        "next": "acp run-action bind_merge" if new_status == "ready" else "acp run-action semantic_bind",
    }

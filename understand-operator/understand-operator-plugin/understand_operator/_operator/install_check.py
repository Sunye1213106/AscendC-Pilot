...
CHECK_FILES = (
    ...
    "understand_operator/scripts/validate_candidate_batch.py",
    "understand_operator/scripts/compile_candidate_facts.py",
    "understand_operator/scripts/evaluate_review_trigger.py",
    "understand_operator/scripts/validate_spec_consistency.py",
    "understand_operator/scripts/validate_fact_stage.py",
    "understand_operator/scripts/build_fact_registry.py",
    "understand_operator/scripts/build_query_index.py",
    "understand_operator/scripts/verify_required_scripts.py",
    ...
    "skills/understand-operator/validate_candidate_batch.py",
    "skills/understand-operator/compile_candidate_facts.py",
    "skills/understand-operator/evaluate_review_trigger.py",
    "skills/understand-operator/validate_spec_consistency.py",
    "skills/understand-operator/validate_fact_stage.py",
    "skills/understand-operator/build_fact_registry.py",
    "skills/understand-operator/build_query_index.py",
    "skills/understand-operator/verify_required_scripts.py",

...
> 文档索引：[`docs/README.md`](../README.md)。组合式分层：[`skill-prompt.md`](./skill-prompt.md)。
...
5. **改完 compose + 单测 +（需要时）更新 `docs/`**；安装侧刷新后重启才算生效。
...
- 在 capability / METHOD / task prompt 里复述 Policy 已写明的规则。

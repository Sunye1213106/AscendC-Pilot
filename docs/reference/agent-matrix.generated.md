...
| `tg-analyst` | `llm` | `producer` | `subagent` | `pilot:tg/**`, `pilot:uo/**`, +12 | `pilot:runs/**/actions/bind_init/parts/**`, `pilot:runs/**/actions/bind_init/scratch/**`, +14 | `agents/tg-analyst.yaml` |

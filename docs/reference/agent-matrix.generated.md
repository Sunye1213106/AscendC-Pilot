...
| `tg-analyst` | `llm` | `producer` | `subagent` | `pilot:tg/**`, `pilot:uo/**`, +11 | `pilot:runs/**/actions/bind_init/parts/**`, `pilot:runs/**/actions/bind_init/scratch/**`, +1 | `agents/tg-analyst.yaml` |

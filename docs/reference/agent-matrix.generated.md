...
| `ce-analyst` | `llm` | `producer` | `subagent` | `pilot:ce/plan/**`, `pilot:session_handoff.md`, +9 | `pilot:runs/**/actions/intent_grill/parts/**`, `pilot:runs/**/actions/intent_grill/scratch/**`, +5 | `agents/ce-analyst.yaml` |
| `ce-applier` | `llm` | `producer` | `subagent` | `pilot:ce/plan/**`, `pilot:uo/**`, +7 | `source:op_host/**`, `source:op_kernel/**`, +4 | `agents/ce-applier.yaml` |
| `ce-reviewer` | `llm` | `readonly_reviewer` | `subagent` | `pilot:uo/**`, `pilot:ce/plan/**`, +11 |  | `agents/ce-reviewer.yaml` |
...
| `tg-analyst` | `llm` | `producer` | `subagent` | `pilot:tg/**`, `pilot:uo/**`, +18 | `pilot:runs/**/actions/bind_init/parts/**`, `pilot:runs/**/actions/bind_init/scratch/**`, +14 | `agents/tg-analyst.yaml` |

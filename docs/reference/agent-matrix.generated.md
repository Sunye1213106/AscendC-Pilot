...
| `ce-analyst` | `llm` | `producer` | `subagent` | `pilot:ce/plan/**`, `pilot:session_handoff.md`, +7 | `pilot:runs/**/actions/intent_grill/parts/**`, `pilot:runs/**/actions/intent_grill/scratch/**`, +4 | `agents/ce-analyst.yaml` |

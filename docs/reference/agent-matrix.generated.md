...
| `tg-lemma-producer` | `llm` | `producer` | `subagent` | `pilot:tg/closure/lemmas/leads.yaml`, `pilot:tg/closure/**`, +7 | `pilot:runs/**/actions/lemma_mine/parts/**`, `pilot:runs/**/actions/lemma_mine/scratch/**`, +1 | `agents/tg-lemma-producer.yaml` |

...
| --- | --- | --- | --- | --- | --- |
| `uo-init` | `/uo-init` | prepare, extract, analyze, commit, verify | prepare, extract, analyze, commit, verify | ascendc-pilot | layout_receipt, scope_receipt, extract_receipt, uo_product_ready |

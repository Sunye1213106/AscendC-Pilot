...
Harness：`engines/understand-operator/tools/fag_arch35_cold_start.py`。收据：`artifacts/fag-arch35-rebuild/cold-start-120s/{run.log,rebuild.json}`。
...
python engines/understand-operator/tools/fag_arch35_cold_start.py

...
- run: `2026-08-03T12:25:09.748426+00:00`  op: `FlashAttentionScoreGrad`  arch: `arch35`

| metric | value |
| --- | ---: |
| CLOSED (exact + constant) | **15/19** |
| INPUT_DERIVABLE | **13/19** |
| unique free_vars | **6** |
...
| `(coreIdx >= CORE_LIST_NUM)` | flash_attention_score_grad_tiling_varlen_regbase.cpp:1279 | 3 | IsNzOut, IsTndSwizzle, SplitAxis |
...
| 1 | SplitAxis | overapproximated | no | 4 |
...
| 17 | IsTndSwizzle | overapproximated | no | 6 |
